/* ============================================================
   THE RETURN KEYWORD
   return hands a value OUT of the function and stops it.
   Includes add / multiply / lastElement / capitalize / sumArray.
   NOTE: last line 'results(5, 4)' is a leftover typo - kept as written.
   ============================================================ */
